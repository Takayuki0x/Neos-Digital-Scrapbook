    ...
    return (
        <div className="min-h-screen cursor-default overflow-x-clip">
            ...
            <div className="crt-green">
                <div className="flex items-center justify-center gap-12 overflow-clip hover:cursor-pointer" onClick={rickRoll}>
                ...
                <div className="flex">
                    <div className="w-3/12 flex flex-col items-center justify-center mt-20">
                        <img src="/danger-sign.gif" className="w-24 h-34 hover:cursor-pointer" onClick={rickRoll} />
                    </div>
                ...
                <div className="flex items-center justify-center gap-12 mt-16 overflow-clip hover:cursor-pointer">
                    <img src="/danger-rotating.gif" className="w-48 h-48" onClick={rickRoll}/>
                    <img src="/danger-rotating.gif" className="w-48 h-48" onClick={rickRoll}/>
                    <img src="/danger-rotating.gif" className="w-48 h-48" onClick={rickRoll}/>
                    <img src="/danger-rotating.gif" className="w-48 h-48" onClick={() => {
                        navigateTo("/pickapill")
                    }}/>
                    <img src="/danger-rotating.gif" className="w-48 h-48" onClick={rickRoll}/>
                    <img src="/danger-rotating.gif" className="w-48 h-48" onClick={rickRoll}/>
                    <img src="/danger-rotating.gif" className="w-48 h-48" onClick={rickRoll}/>
                        ...
                        <div className="border border-green-500 bg-black h-full w-full">
                            ...
                            <div className="text-green-600 pl-4 text-wrap font-ocraextended">
                                ...
                                <div className="flex">
                                    ...
                                    <img src="/computer.gif" className="w-24 h-24 mr-4 hover:cursor-pointer" onClick={rickRoll} />
                                </div>
                                <br />
                                <p>
                                ...
                                <img src="/fondomatrix.gif" className="w-full mt-4 hover:cursor-pointer" onClick={rickRoll} />
                ...
                <div className="flex hover:cursor-pointer" onClick={rickRoll}>
